...
public class ProductServiceImpl implements ProductService {
    ...
    private void loadProducts(){
        ...
        springIntro.setCourseDescription("APRENDE PELAVERTGA");
        ...
        springCoreUltimate.setCourseDescription("APRENDE PELAVERTGA");
        ...
        thymeleaf.setCourseDescription("APRENDE PELAVERTGA");
        thymeleaf.setPrice(new BigDecimal("0"));
        ...
        springCore.setCourseDescription("APRENDE PELAVERTGA");
        springCore.setPrice(new BigDecimal("0"));
        ...
        springCoreDevOps.setCourseDescription("APRENDE PELAVERTGA");
        springCoreDevOps.setPrice(new BigDecimal("0"));
